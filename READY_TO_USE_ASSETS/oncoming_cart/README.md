...
Use `oncoming_cart.glb`. Load it once with Three.js `GLTFLoader`, then clone or
...
- `approach_loop`: frames 1–30 at 30 fps (loop) — Synchronized wheel rotation and urgent headlamp pulse.

## Runtime notes

- Oncoming motion and collision remain track-space controlled.
